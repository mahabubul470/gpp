//! `gpp-diff` — line-based diff engine.
//!
//! Phase 1 provides the traditional line-based fallback: unified diffs and
//! per-file statistics. The tree-sitter semantic diff engine arrives in
//! Phase 2 (see `docs/ROADMAP.md`); higher layers should treat this as the
//! `--line` path.
#![forbid(unsafe_code)]
